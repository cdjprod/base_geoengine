        ...
        _.each(bg_layers, function(l) {
            if (l.is_wmts) {
                ...
                var opt = {
                    ...
                    /*attribution: "<a href='http://www.camptocamp.com' style='color:red;font-weight:bold;background-color:#FFFFFF' target='_blank'>Powered by Camptocamp</a>\
                        ...
                        out.push(
                            new OpenLayers.Layer.OSM(
                                ...
                                /*'http://tile.openstreetmap.org/${z}/${x}/${y}.png', {
                                    attribution: "<a href='http://www.camptocamp.com' style='color:green;font-weight:bold;background-color:#FFFFFF' target='_blank'>Powered by Camptocamp</a>\
                    ...
                    case "mapbox":
                        out.push(
                            new OpenLayers.Layer.XYZ(l.name, [
                                ...
                                wrapDateLine: true,
                                numZoomLevels: 17
                                /*attribution: "<a href='http://www.camptocamp.com' style='color:blue;font-weight:bold;background-color:#FFFFFF' target='_blank'>Powered by Camptocamp</a>\
                                          using <a href='http://www.openstreetmap.org/' target='_blank'>OpenStreetMap</a> raster"*/
                            })
                        );
                        break;
